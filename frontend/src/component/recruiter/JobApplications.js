...
const ApplicationTile = (props) => {
    ...
    axios
      ...
      .then((response) => {
        ...
        if (status === "shortlisted") {
          // Set applicant's mobile number and show the "Send Message" link
          setApplicantMobile(application.jobApplicant.mobile);
  ...
  const sendMessage = () => {
    // Implement sending a text message to the applicant's mobile number
    // You can use an appropriate service or API for sending SMS
    // Example using Axios:
    axios.post("http://localhost:4444/api/send-message", {
      mobile: applicantMobile,
      message: "आपका आवेदन स्वीकृत कर लिया गया है, आपको अगले 72 घंटों तक एक फ़ोन कॉल प्राप्त हो सकती है.",
    })
    .then((response) => {
      setPopup({
        open: true,
        ...
        <Grid item xs>
          <Button
            ...
            onClick={() => {
              ...
              setShowSendMessage(true); // Show "Send Message" link
            }}
          >
            Accept
          </Button>
      ...
      <Grid container>
        ...
        <Grid item container direction="column" xs={3}>
          ...
          <Grid item container xs>
            ...
            {showSendMessage && ( // Conditionally render "Send Message" link
              <Grid item xs>
                <Button
                  className={classes.statusBlock}
                  style={{
